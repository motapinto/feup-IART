        ...
        if manhattan_dist_values:
           ...
           # If more than one path have same manhattan distance, then a random choice of one of them is analyzed and carried forward
            if manhattan_dist_values.count(shortest_path) > 1:
                ...
                choice = random.choice(min_paths)
...
if __name__ == '__main__':
    ...
    # start = [1, 6, 2, 5, 7, 3, 0, 4, 8]
    # start = [1, 3, 6, 5, 2, 0, 4, 7, 8]
    # start = [5, 1, 3, 4, 2, 0, 7, 8, 10, 6, 11, 12, 9, 13, 14, 15]
    # start = [15, 8, 9, 14, 5, 10, 1, 0, 12, 4, 3, 13, 11, 2, 7, 6]
    st.visited.append(start)
